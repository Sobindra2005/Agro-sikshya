...
export default function Sidebar() {
  return (
    ...
    <div className='p-2 w-52 space-y-44 fixed bg-white left-0 top-0 bottom-0'>
    <div className='flex justify-start items-center '>
       ...
       <p className='font-bold text-xl text-primary ml-1'>Agro-sikshya</p>
        ...
        <ul className='space-y-4 font-bold'>
             <li ><Link to='/'className='flex ml-2 text-sm text-primary hover:text-accent items-center '><FaBookOpen className='mr-2'/>Course</Link></li>
             <li ><Link to='/'className='flex ml-2 text-sm text-primary hover:text-accent items-center '><VscGraph className='mr-2'/>Business Planner</Link></li>
             <li ><Link to='/'className='flex ml-2 text-sm text-primary hover:text-accent items-center '><BsGraphUpArrow className='mr-2'/>Market Trend</Link></li>
             <li ><Link to='/'className='flex ml-2 text-sm text-primary hover:text-accent items-center '><FaUsers className='mr-2'/>Community Forum</Link></li>
             <li ><Link to='/  'className='flex ml-2 text-sm text-primary hover:text-accent items-center '><FaUserCircle className='mr-2'/>User Profile</Link></li>
        </ul>
      <div>
        <p><Link to='/setting' className='flex p-2 m-2 items-center font-bold text-sm text-primary hover:text-accent'><CiSettings className='text-xl mr-1'/>Setting</Link></p>
      </div>
    </div>
    </div>
    </>
